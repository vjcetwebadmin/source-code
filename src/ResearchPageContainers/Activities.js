    ...
    render() {
        ...
        <HeadingFour data={this.EventTitle1} className="Heading" />*/}
               ...
               <p align="left" ><b>Master of Business Administration</b></p>
                  <p align="left" style={{lineHeight:1.5}} >There are four faculty members with PhD, who are currently working in this department. Currently, three research scholars are doing PhD under the guidance of Dr. Cyriac Joseph and three has already completed Ph.D. The MBA department organises various innovative seminars, training programmes etc.</p>  
                  ...
                  <p align="justify" style={{lineHeight:1.5}} >The ECE department organizes different training programmes, workshops and seminars on emerging technologies in their field. Two faculty members with PhD are currently working in this department and many faculty members are pursing Ph.D in reputed institutes. Many faculty members have already published their papers in reputed SCI/Scopus indexed journals. Many faculty members of the ECE department have received grants for projects from government (KSCSTE)/non-government agencies (IEEE SIGHT). The ECE department constantly encourages their faculty members to publish articles in Scopus/SCI indexed journals/conferences.</p>  
   
                  <p align="left" ><b>Department of Civil Engineering</b></p>
                  <p align="justify" style={{lineHeight:1.5}} >The Civil department organizes different workshops, KTU sponsored faculty development programmes and seminars on the latest technologies. Currently, three faculty members with PhD are working in this department and several faculty members are pursuing Ph.D in esteemed institutes. Faculty members of this department have published articles in reputed indexed journals/conferences.</p>  

                  <p align="left" ><b>Department of Information Technology</b></p>
                  <p align="justify" style={{lineHeight:1.5}} >The IT department organizes different training programmes, workshops and seminars on the latest technologies such as the Internet of things, artificial intelligence etc. Currently, one faculty member with a PhD is working in this department. At present, three faculty members are pursuing Ph.D in reputed universities. Many faculty members have published their papers in reputed Scopus journals.</p>  

                  <p align="left" ><b>Department of Science & Humanities</b></p>
                  <p align="justify" style={{lineHeight:1.5}} >The S&H department organizes training programmes, workshops and seminars on recent trends.. The S&H department encourages their faculties to publish articles in reputed journals/conferences. One faculty member is recognized as a research guide under Mahatma Gandhi University.</p>  
                  <p align="left" >Research Guide</p>
                  ...
                  <br />
                   ...
                   <tr><td rowSpan="6">1</td><td rowSpan="6">Dr. Cyriac Joseph</td><td rowSpan="6">MBA</td><td>Mr. Amal Sharin T.J</td></tr>
                   ...
                   <tr><td>4</td><td>Dr. Anishin Raj M.M</td><td>CSE</td><td>Recognized as Research Guide under KTU. Students not assigned</td></tr>
                   <tr><td>5</td><td>Dr. Sony Kurian</td><td>EEE</td><td>Recognized as Research Guide under KTU. Students not assigned</td></tr>
                   <tr><td>6</td><td>Dr. K. Shunmugesh</td><td>ME</td><td>Recognized as Research Guide under KTU. Students not assigned</td></tr>
                   <tr><td>7</td><td>Dr. Sajan T John</td><td>ME</td><td>Recognized as Research Guide under KTU. Students not assigned</td></tr>
                   </table>
