        ...
        <p>
          <div class="ticker-wrapper-h">
            ...
            <ul class="news-ticker-h">
              ...
              <li><b><a href="#/newseight">Invites Applications for the post of Placement and Training Officer cum Assistant Professor. <span style={{color:"blue",fontWeight:"normal"}}>more...</span></a></b></li>
              <li>||</li>
              <li><b><a href="/downloads/FDP_ECE Brochure.pdf" target="_blank">5 days faculty development programme on "ADVANCES IN COMMUNICATION ENGINEERING" <span style={{color:"blue",fontWeight:"normal"}}>more...</span></a></b></li>
              <li>||</li>
