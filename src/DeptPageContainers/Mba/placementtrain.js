...
class CSFaculty extends Component {
  state = {};
    ...
    LibraryContent4 = {
      ...
      title: "VISWAJYOTHI CORPORATE RESOURCE CENTRE (VCRC), the consultancy wing of VJCET helps organizations imagine change, explore ideas, build capabilities, and implement organizational transformation. The VSMS team will partner with you to convert ideas into reality. We can provide you with industry-specific, actionable solutions to deal with your everyday and not everyday kind of problems. We combine faculty and student resources, bringing in expertise from diverse areas. We will develop unique work models to suit clients that will ensure perfect results. Our team is keen to collaborate and deliver expanded expectations. Technical capabilities, human strengths, rectitude, and a fastidious work style will turn client dreams into reality."
    } 
    LibraryContent5 = {
      instanceID: "LibraryContent5",
      title: "Dr. Jose Mamman, Project Head and Assistant professor, VSMS, Dr.Cyriac Joseph, Dean, VSMS,  Mr. Pratheep Kumar, Assistant professor, VSMS, Mr. Anish John A, Assistant professor, VSMS, and Dr.Geo Baby, External Consultant."
    } 
