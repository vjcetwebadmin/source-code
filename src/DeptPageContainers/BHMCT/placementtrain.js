...
class CSFaculty extends Component {
  state = {};
    ...
    LibraryServiceTitle9 = {
      instanceID: "LibraryServiceTitle9",
      title: "INDUSTRY INTERACTIONS"
    };
    LibraryContent9 = {
      instanceID: "LibraryContent9",
    ...
    return (
      <div >
        ...
        <p>
          ...
          <BodyOneJustified data={this.LibraryContent8}/>
        </p>
        <p>
          <HeadingTwo data={this.LibraryServiceTitle9} className="Heading" />
          <BodyOneJustified data={this.LibraryContent9}/>
        </p>               
        <p>
