...
class Profile extends Component {
  ...
  Features2 = {
    ...
    title: "•	Board of Research Nuclear in Science (BRNS), under the Department of Atomic Energy, sanctioned a research project of worth Rs.33.03 lakhs."
  };
  Features3 = {
  ...
  Features6 = {
    ...
    title: "•	Encouraging sustainable development, Department runs three on grid solar power plants with a total capacity of 280kWp in the campus"
  };
  Features7 = {
